...
![Fig. 1. Bimodal Hyperball Uniform Distribution](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p03-fig01.png)
...
![Fig. 2. HAETAE signature algorithm](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p03-fig02.png)
...
![Fig. 3. Reconstructed Key Recovery Algorithm for Sampling Seed Attacks](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p06-fig03.png)
...
![Fig. 4. Fault injection environment configuration diagram](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p07-fig04.png)
...
![Fig. 5. Configuring a Software Fault Injection Attack Simulation](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p07-fig05.png)
...
![Fig. 6(a). LSB Attack](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p08-fig06a-lsb.png)

![Fig. 6(b). UnpackA Attack](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p08-fig06b-unpack.png)

![Fig. 6(c). Sign bit b Attack](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p08-fig06c-signbit.png)

![Fig. 6(d). Sampling Seed Attack](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p08-fig06d-seed.png)
...
![Table 1. Detected glitch parameters](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p09-table01.png)
...
![Fig. 7. List of internal assemblies related to LSB](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p09-fig07.png)
...
![Table 2. Fault injection analysis results by attack target](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p09-table02.png)
...
![Table 3. Overhead Evaluation of Sign-Then-Verify](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p10-table03.png)
...
![Table 4. Overhead evaluation of moving inside the rejection sampling loop](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p10-table04.png)
...
![Table 5. Overhead Evaluation of Partial Double Operation Countermeasures](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p11-table05.png)
...
![Table 6. Overhead Evaluation of Sanity check](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p11-table06.png)
...
![이상원 저자 사진](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p14-author-sangwon-lee.png)

이 상 원 (Sangwon Lee) 학생회원 2025년 2월: 호서대학교 컴퓨터공학부 학사 2026년 2월: 호서대학교 대학원 정보보호학과 석사 &lt;관심분야&gt; 부채널 공격, 하드웨어 보안, 네트워크 보안

![김윤성 저자 사진](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p14-author-yunsung-kim.png)

김 윤 성 (Yunsung Kim) 학생회원 2026년 2월: 호서대학교 컴퓨터공학부 학사 2026년 3월~현재: 호서대학교 대학원 정보보호학과 석사과정 &lt;관심분야&gt; 네트워크 보안, 인공지능 보안, 부채널 공격

![하재철 저자 사진](양자 내성 암호 HAETAE에 대한 오류 주입 공격 및 대응 기법/p14-author-jaecheol-ha.png)
