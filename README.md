...
> 인증된 사용자 전용 · 에어갭 격리 VMware 환경에서 운용되는 ChipWhisperer 분석 플랫폼
...
본 저장소는 **에어갭(Air-Gap)으로 보호된 격리 VMware 환경** 위에서 동작하며, 인증된 사용자만 접근 가능합니다. 모든 설정은 Ubuntu 게스트 OS를 기준으로 작성되었습니다.
